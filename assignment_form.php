...
<body>
    ...
    <div class="page-wrap">
        <div class="form-card">
            ...
            <?php if (isset($_GET['status']) && $_GET['status'] == 'success') echo "<p class='success-msg'>Complaint assigned successfully!</p>"; ?>
            <?php if (isset($_GET['status']) && $_GET['status'] == 'error') echo "<p class='error-msg'>" . htmlspecialchars($_GET['msg'] ?? 'Assignment failed.') . "</p>"; ?>
