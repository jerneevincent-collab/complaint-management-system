...
<head>
    ...
    <style>
        ...
        .topbar .brand img { width: 52px; height: 52px; border-radius: 50%; }
        .topbar .brand span { font-weight: 600; font-size: 15px; }
        .topbar .user-info { display: flex; align-items: center; gap: 16px; font-size: 14px; }
        .topbar .user-info a { color: #cbd5e1; }
        .topbar .user-info a:hover { color: #fff; }
        .user-badge { display: flex; align-items: center; gap: 8px; }
                .user-badge img { width: 36px; height: 36px; }

        .dashboard-wrap { max-width: 1100px; margin: 0 auto; padding: 30px 20px; }
        ...
        .module-card h3 {
            color: var(--navy); margin: 0 0 12px; font-size: 15px;
            display: flex; align-items: center; gap: 8px;
        }
               .module-card h3 img { width: 36px; height: 36px; }
        .module-card h3 { font-size: 16px; gap: 10px; }

        .module-card ul { list-style: none; padding: 0; margin: 0; }
        .module-card ul li { background: none; border: none; box-shadow: none; padding: 6px 0; margin: 0; }
        .module-card ul li a {
            color: #334155; font-weight: 500; font-size: 14px;
            transition: color 0.2s, padding-left 0.2s; display: inline-block;
        }
        .module-card ul li a:hover { color: var(--accent); padding-left: 4px; text-decoration: none; }
    </style>
</head>
<body>
    <div class="topbar">
        ...
        <div class="user-info">
            <span class="user-badge"><img src="assets/account-logo.png" alt="Account"> <?php echo htmlspecialchars($_SESSION['full_name']); ?></span>
    ...
    <div class="dashboard-wrap">
        ...
        <div class="module-grid">
            <div class="module-card">
                <h3><img src="assets/complaint-logo.png" alt=""> Complainant Management</h3>
                <ul>
            ...
            <div class="module-card">
                <h3><img src="assets/complaint-logo.png" alt=""> Complaint Management</h3>
                <ul>
            ...
            <div class="module-card">
                <h3><img src="assets/assignment-logo.png" alt=""> Assignment</h3>
                <ul>
            ...
            <div class="module-card">
                <h3><img src="assets/investigation-logo.png" alt=""> Investigation</h3>
                <ul>
            ...
            <div class="module-card">
                <h3><img src="assets/action-logo.png" alt=""> Action</h3>
                <ul>
            ...
            <div class="module-card">
                <h3><img src="assets/resolution-logo.png" alt=""> Resolution</h3>
                <ul>
            ...
            <div class="module-card">
                <h3><img src="assets/reports-logo.png" alt=""> Reports and Dashboard</h3>
                <ul>
            ...
            <div class="module-card">
                <h3><img src="assets/documentation-logo.png" alt=""> Documentation</h3>
                <ul>
